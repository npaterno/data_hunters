...
#' 
#' From World Bank, gross domestic product (GDP) and population 1960-2020
#'
...
#' library(dplyr)
#' 
#' # List countries' per capita GDP, sorted by per capita GDP
#'country_gdp_pop %>%
#'  mutate(gdp_per_capita = round(1000000*gdp/year_2020),0) %>%
